...
import style from './seacrch.module.css'

const Seacrh = () => {

  return (
    <form className={style.search}>
      <button className={style.serch_button} onClick={(e) => {
        e.preventDefault()

        document.querySelector(`.inputs`).classList.toggle(`${style.active}`)
...
116 620 135 145 14 419 12 567 -4z"/>
      ...
      <label className={style.label_serch} htmlFor="">
        <input className={`${style.serch_input} inputs`} type="text" />
